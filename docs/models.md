...
would be roughly 2.5× faster, but the 1.5B *already* fabricates occasionally — it has invented a
...
expected 2–3× because rewriting mostly copies its input. Measured at temperature 0 with fixed seed
...
**Larger VAD windows** — 3× faster and *clipped up to 2976 ms of speech* on real audio.
